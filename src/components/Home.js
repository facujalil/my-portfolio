    ...
    <section id="home">
      <div className="home-content">
        <div className="home-text-container">
          ...
          <p>
            {language === "es"
              ? "Tengo 22 años y vivo en Rosario, Argentina. Mi objetivo es formar parte de un equipo de trabajo en donde pueda consolidarme profesionalmente y contribuir en los logros organizacionales."
              : "I'm 22 years old and I live in Rosario, Argentina. My goal is to be part of a work team where I can consolidate myself professionally and contribute to organizational achievements."}
          </p>
          <a
